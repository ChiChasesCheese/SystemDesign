...
source: https://sre.google/sre-book/managing-critical-state/
...
<sup>[112](#id-Xe4u4ioHA-marker)</sup>Kyle Kingsbury has written an extensive series of articles on distributed systems correctness, which contain many examples of unexpected and incorrect behavior in these kinds of datastores. See [*https://aphyr.com/tags/jepsen*](https://aphyr.com/tags/jepsen).

<sup>[113](#id-jE2uxSEIwhM-marker)</sup>In particular, the performance of the original Paxos algorithm is not ideal, but has been greatly improved over the years.
