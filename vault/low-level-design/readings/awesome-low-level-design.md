---
nodes: [method.delivery, patterns.selection]
url: https://github.com/ashishps1/awesome-low-level-design
tags: [index]
---
# awesome-low-level-design (ashishps1)

The most complete open index of LLD interview material: OOP, SOLID,
all GoF patterns, concurrency topics, and 40+ classic problems with
